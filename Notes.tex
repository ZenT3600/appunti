...
\begin{document}
  ...
  \section{Informatica}
  {
    ...
    In Java, come nella maggior parte dei linguaggi di programmazione, tutto si svolge all'interno del \textbf{main}, il cuore del programma, e tutta la nostra logica deve partire da li'. Il main in Java e' definito come:
    ...
    Una variabile e' un contenitore per un dato di un determinato tipo con un nome ed un valore. Una variabile si puo' definire nel seguente modo:
    ...
    \begin{minted}{java}
      ...
      serieDiFibonacci[0] = 0;
      serieDiFibonacci[1] = 1;
      serieDiFibonacci[2] = 1;
      serieDiFibonacci[3] = 2;
      serieDiFibonacci[4] = 3;
      serieDiFibonacci[5] = 5;
      serieDiFibonacci[6] = 8;
      serieDiFibonacci[7] = 13;

      // Preleviamo un valore dall'array
      int primaPosizioneSerie = serieDiFibonacci[0];
    \end{minted}
    ...
    In programmazione i condizionali sono diramazioni del condice in base a condizione, ovvero una qualsiasi operazione che ritorna un risultato vero, \texttt{true}, o falso, \texttt{false}. Un condizionale, o \texttt{if} per semplicita', e' rappresentabile in Java come:
    ...
    Per definire un metodo, si puo' dire che esso non e' altro che \textit{un sottoprogramma, con i suoi input, la sua logica ed i suoi output}. Per assurdo, qualsiasi cosa possiamo sviluppare come metodo, puo' anche essere sviluppata come programma a parte che, opzionalmente, richiede un qualche input.
