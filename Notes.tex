...
\begin{document}
  ...
  \section{Informatica}
  {
    ...
    In Java, come nella maggior parte dei linguaggi di programmazione, tutto si svolge all'interno del \textbf{main}, il cuore del programma, e tutta la nostra logica deve partire da li'.
